...
public class TelaHomePassageiro extends JFrame {
	...
	private void configButton() {
		...
		JButton btnListarCorrida = FabricaJButton.criarJButton("Listar Corrida", 270, 190, 380, 240, new Color(28, 28, 20),
				new Color(179, 177, 177), 28);
		btnListarCorrida.addMouseListener(null);
		JButton btnCadastrarCorrida = FabricaJButton.criarJButton("Cadastrar Corrida", 270, 440, 380, 240, new Color(28, 28, 20),
				new Color(179, 177, 177), 28);
